...
class TensorFlowClassifier implements Classifier {
  ...
  private final String[] class_labels =  {"Avion", "Bicicleta", "Pajaro", "Barco", "Botella", "Autobus", "Carro",
          "Gato", "Silla", "Vaca", "Comedor", "Perro", "Caballo", "Motocicleta", "Persona",
          "Planta en Maceta", "Oveja", "sofa", "Tren","Television"};
  ...
  public List<Recognition> recognizeImage(final Bitmap bitmap) {
    ...
    Log.i("k",class_labels[predicted_class]);
    Trace.endSection();
    return recognitions;
  }
